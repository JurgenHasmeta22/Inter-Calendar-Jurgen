        ...
        >
          <header className="modal-header">
            ...
            <div className="appointement-info">
              <span>
                <strong>Id: </strong> {appointementSpecific?.id}{" "}
              </span>
              <span>
                <strong>Price: </strong> {appointementSpecific?.price}{" "}
              </span>
              <span>
                <strong>Start Date: </strong> {appointementSpecific?.startDate}{" "}
              </span>
              <span>
                <strong>End Date: </strong> {appointementSpecific?.endDate}{" "}
              </span>
              <span>
                <strong>Title: </strong> {appointementSpecific?.title}{" "}
              </span>
              <span>
                <strong>Status: </strong> {appointementSpecific?.status}{" "}
              </span>
              <span>
                <strong>Doctor Id: </strong>
                {appointementSpecific?.doctor_id !== null
                  ? appointementSpecific?.doctor_id
                  : "null"}
              </span>
              <span>
                <strong>Doctor userName: </strong>{" "}
                {user?.isDoctor ? user?.userName : selectedDoctor?.userName}{" "}
              </span>
              <span>
                <strong>Patient Id: </strong>
                {appointementSpecific?.user_id !== null
                  ? appointementSpecific?.user_id
                  : "null"}
              </span>
              <span>
                <strong>Patient userName: </strong> {getPatientUserName()}{" "}
              </span>
              <span>
                <strong>Appointement Desc: </strong>{" "}
                {appointementSpecific?.description}{" "}
              </span>
            </div>
          </header>
        </div>
